...
import Meds from "./pages/Meds"; // <--- NEW IMPORT
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#fffaf3] via-[#fff1e8] to-[#ffe7e0]">
      <div className="pt-20">
        ...
        <main className="min-h-screen flex items-center justify-center relative z-10 px-6 pt-16">
          <div className="w-full max-w-3xl text-center">
            <motion.header initial="hidden" animate="visible">
              ...
              <motion.p variants={heroSubVariant} className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto">
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/meds" element={<Meds />} /> {/* <-- Medicines page added */}
        <Route path="*" element={<HomeHero />} />
      </Routes>
